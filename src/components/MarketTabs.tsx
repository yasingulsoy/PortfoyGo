          ...
          <div className="overflow-x-auto -mx-4 sm:mx-0 hidden sm:block">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 sm:px-6 py-3 text-left text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider">Hisse</th>
                  <th className="px-4 sm:px-6 py-3 text-right text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider">Fiyat</th>
                  <th className="px-4 sm:px-6 py-3 text-right text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider">Değişim</th>
                  <th className="px-4 sm:px-6 py-3 text-center text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider">İşlem</th>
                </tr>
              </thead>
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="overflow-x-auto -mx-4 sm:mx-0 hidden sm:block">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 sm:px-6 py-3 text-left text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider">Token</th>
                  <th className="px-4 sm:px-6 py-3 text-right text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider">Fiyat</th>
                  <th className="px-4 sm:px-6 py-3 text-right text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider">24s</th>
                  <th className="px-4 sm:px-6 py-3 text-center text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider">İşlem</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {cryptos.map((c) => (
                  <tr key={c.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900">${c.current_price.toLocaleString()}</td>
                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-right">
