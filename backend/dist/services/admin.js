...
class AdminService {
    ...
    static async getAllUsers(limit = 50, offset = 0) {
        try {
            const usersResult = await database_1.default.query(`SELECT id, username, email, email_verified, balance, portfolio_value, total_profit_loss, rank, created_at, last_login
         FROM users
