...
async function createAllTables() {
    ...
    `);
        await database_1.default.query(`CREATE INDEX IF NOT EXISTS idx_currency_rates_code ON currency_rates(code);`);
        await database_1.default.query(`CREATE INDEX IF NOT EXISTS idx_currency_rates_updated_at ON currency_rates(updated_at DESC);`);
